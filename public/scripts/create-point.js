...
let selectedItems = [] // const(constante) let(variável)

function handleSelectedItem(event){
    const itemLi = event.target

    //add or remove class com javaScript
    itemLi.classList.toggle("selected") //toggle adiciona ou remove a classe conforme a lista
